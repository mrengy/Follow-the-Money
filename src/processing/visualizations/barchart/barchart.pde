...
void draw() {
   ...
   background(255);
   float[] pieces1 = {246268768,280196760,4000000,200000000};
   ...
   barchart(pieces1, 150, 50, 125, 300, 10, 110, 75, 255, 0);
   barchart(pieces1, 150, 400, 125, 300, 145, 32, 175, 255, 0);
   barchart(pieces1, 500, 50, 300, 700, 45, 76, 220, 255, 1);
}
 
void barchart(float[] pieces,float yf1, float xf1, float yscale, float xscale, int r1, int g1, int b1, int a1, int labelplacement) {
